...
<body>
	...
	<form method=POST action="addM.do">

		<label for="companyName">Company Name:</label><br> 
		<input	type="text" id="companyName" name="companyName"
			value="${addedManufacturer.companyName} "><br> 
			
		<label for="description">Company Description:</label><br>

		<textarea id="description" name="description" maxlength="500"
			 rows="4" value="${addedManufacturer.description}" cols="50"></textarea>
			
		<br> <label for="url">URL:</label><br> 
		<input type="text" id="url" name="url" value="${addedManufacturer.url}" required><br> 
			
			<label for="country"> Base Country:</label><br>
		
		    <select value="${addedManufacturer.country}" id="country" name="country">
		...
		<br> <label for="year">Year Founded:</label><br> 
		
	    <select name="year" value="${addedManufacturer.yearFounded}"> 
